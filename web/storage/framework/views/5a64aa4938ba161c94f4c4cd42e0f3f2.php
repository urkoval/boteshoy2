...
Cómo se juega a <?php echo e($juego->nombre); ?> | Guía Completa 2026
<?php $__env->stopSection(); ?>

<?php $__env->startSection('description'); ?>
Aprende cómo se juega a <?php echo e($juego->nombre); ?>: reglas, premios, probabilidades y consejos. Guía completa paso a paso actualizada.
<?php $__env->stopSection(); ?>
...
<div class="mb-6">
    <a href="<?php echo e(route('juego', $juego->slug)); ?>" class="<?php echo e($color['text']); ?> font-medium hover:underline inline-flex items-center gap-1">
        <span>←</span> Ver últimos resultados de <?php echo e($juego->nombre); ?>

    </a>
</div>

<div class="<?php echo e($color['bg']); ?> rounded-xl shadow-lg p-6 mb-8">
    <h1 class="text-3xl font-bold text-white">Cómo se juega a <?php echo e($juego->nombre); ?></h1>
    <p class="text-white/90 mt-2">Guía completa con reglas, premios y probabilidades</p>
</div>

<section class="bg-white rounded-xl shadow-md p-6 mb-8">
    <h2 class="text-xl font-bold text-slate-800 mb-6">Guía de <?php echo e($juego->nombre); ?></h2>
...
<div class="mt-8 bg-gradient-to-r from-slate-50 to-blue-50 rounded-xl p-6 border border-slate-200">
    ...
    <a href="<?php echo e(route('juego', $juego->slug)); ?>" class="<?php echo e($color['bg']); ?> text-white px-6 py-3 rounded-lg font-medium hover:opacity-90 inline-block">
...
<section class="mt-8 bg-slate-50 rounded-xl p-6">
    ...
    <div class="grid md:grid-cols-3 gap-4">
        ...
        <a href="<?php echo e(route('juego.combinacion-ganadora', $juego->slug)); ?>" class="bg-white p-4 rounded-lg hover:shadow-md transition-shadow">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Nire unitatea\python\boteshoy2\web\resources\views/juego-guia.blade.php ENDPATH**/ ?>