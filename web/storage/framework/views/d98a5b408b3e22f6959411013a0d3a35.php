...
Guía Lotería Nacional <?php echo e(date('Y')); ?>: Cómo Funciona, Premios y Décimos
...
<div class="mb-6">
    <a href="<?php echo e(route('juego', 'loteria-nacional')); ?>" class="text-loteria-500 font-medium hover:underline inline-flex items-center gap-1">
...
<section class="bg-white rounded-xl shadow-md p-6 mb-6">
    ...
    <div class="grid md:grid-cols-2 gap-6">
        <div class="bg-amber-50 rounded-lg p-5 border border-amber-200">
            ...
            <a href="<?php echo e(route('loteria.jueves')); ?>" class="inline-block mt-3 text-amber-700 font-medium hover:underline text-sm">Ver resultados →</a>
        </div>
        <div class="bg-amber-100 rounded-lg p-5 border border-amber-300">
            ...
            <a href="<?php echo e(route('loteria.sabado')); ?>" class="inline-block mt-3 text-amber-800 font-medium hover:underline text-sm">Ver resultados →</a>
        </div>
    </div>
</section>
...
<section class="bg-white rounded-xl shadow-md p-6 mb-6">
    ...
    <a href="<?php echo e(route('loteria.decimo-premiado')); ?>" class="inline-block bg-loteria-500 text-white px-6 py-3 rounded-lg font-medium hover:bg-loteria-600 transition">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Nire unitatea\python\boteshoy2\web\resources\views/guia-loteria-nacional.blade.php ENDPATH**/ ?>