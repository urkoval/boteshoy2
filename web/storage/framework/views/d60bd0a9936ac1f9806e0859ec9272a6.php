...
Décimo Premiado Lotería Nacional <?php echo e(date('Y')); ?> | Comprobar Números
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="bg-amber-600 px-6 py-4">
            <div class="flex justify-between items-center">
                ...
                <span class="text-white/80"><?php echo e($ultimoJueves->fecha->format('d/m/Y')); ?></span>
            </div>
        </div>
        <div class="p-6">
            <div class="space-y-4">
                ...
                <div class="flex justify-between items-center p-3 bg-amber-50 rounded-lg">
                    ...
                    <span class="text-2xl font-bold text-amber-700 tracking-widest"><?php echo e($primerJ); ?></span>
                </div>
                <?php endif; ?>
                <?php if($segundoJ): ?>
                <div class="flex justify-between items-center p-3 bg-slate-50 rounded-lg">
                    <span class="text-slate-600 font-medium">2º Premio</span>
                    <span class="text-xl font-bold text-slate-700 tracking-widest"><?php echo e($segundoJ); ?></span>
                </div>
                <?php endif; ?>
                ...
                <div class="flex justify-between items-center p-3 bg-emerald-50 rounded-lg">
                    ...
                    <div class="flex gap-2">
                        ...
                        <span class="w-8 h-8 bg-emerald-500 text-white rounded-full flex items-center justify-center font-bold"><?php echo e($r); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                <?php endif; ?>
            </div>
            <a href="<?php echo e(route('sorteo', ['slug' => 'loteria-nacional', 'fecha' => $ultimoJueves->fecha->format('Y-m-d')])); ?>" 
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="bg-amber-700 px-6 py-4">
            <div class="flex justify-between items-center">
                ...
                <span class="text-white/80"><?php echo e($ultimoSabado->fecha->format('d/m/Y')); ?></span>
            </div>
        </div>
        <div class="p-6">
            <div class="space-y-4">
                ...
                <div class="flex justify-between items-center p-3 bg-amber-50 rounded-lg">
                    <span class="text-slate-600 font-medium">1º Premio</span>
                    <span class="text-2xl font-bold text-amber-800 tracking-widest"><?php echo e($primerS); ?></span>
                </div>
                <?php endif; ?>
                <?php if($segundoS): ?>
                <div class="flex justify-between items-center p-3 bg-slate-50 rounded-lg">
                    <span class="text-slate-600 font-medium">2º Premio</span>
                    <span class="text-xl font-bold text-slate-700 tracking-widest"><?php echo e($segundoS); ?></span>
                </div>
                <?php endif; ?>
            ...
            <a href="<?php echo e(route('sorteo', ['slug' => 'loteria-nacional', 'fecha' => $ultimoSabado->fecha->format('Y-m-d')])); ?>" 
...
<div class="bg-white rounded-xl shadow-lg p-6 mb-6">
    ...
    <div class="grid md:grid-cols-2 gap-4">
        <a href="<?php echo e(route('loteria.jueves')); ?>" class="flex items-center justify-between p-4 bg-amber-50 rounded-lg hover:bg-amber-100 transition-colors">
            <div>
        ...
        <a href="<?php echo e(route('loteria.sabado')); ?>" class="flex items-center justify-between p-4 bg-amber-50 rounded-lg hover:bg-amber-100 transition-colors">
            <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\Nire unitatea\python\boteshoy2\web\resources\views/loteria-decimo-premiado.blade.php ENDPATH**/ ?>