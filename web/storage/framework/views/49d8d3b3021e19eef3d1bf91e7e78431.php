...
<body class="bg-gradient-to-br from-gray-50 to-gray-200 min-h-screen flex flex-col overflow-x-hidden">
    ...
    <nav class="bg-slate-700 text-white shadow overflow-x-clip">
            ...
            <div class="flex gap-2 sm:gap-4">
                    <div class="relative group">
                        ...
                        <div class="absolute top-full left-0 mt-1 bg-slate-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10 min-w-[200px]">
                            <a href="<?php echo e(route('juego.guia', 'euromillones')); ?>" class="block px-4 py-2 text-sm hover:bg-slate-700 transition">Guía Euromillones</a>
                            <a href="<?php echo e(route('juego.guia', 'bonoloto')); ?>" class="block px-4 py-2 text-sm hover:bg-slate-700 transition">Guía Bonoloto</a>
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute top-full left-0 mt-1 bg-slate-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10 min-w-[250px]">
                            ...
                            <a href="<?php echo e(route('juego.apuestas-multiples', 'euromillones')); ?>" class="block px-4 py-2 text-sm hover:bg-slate-700 transition">Euromillones Múltiples</a>
                            <a href="<?php echo e(route('juego.apuestas-multiples', 'bonoloto')); ?>" class="block px-4 py-2 text-sm hover:bg-slate-700 transition">Bonoloto Múltiples</a>
                            <a href="<?php echo e(route('juego.apuestas-multiples', 'la-primitiva')); ?>" class="block px-4 py-2 text-sm hover:bg-slate-700 transition">Primitiva Múltiples</a>
                            <a href="<?php echo e(route('juego.apuestas-multiples', 'el-gordo')); ?>" class="block px-4 py-2 text-sm hover:bg-slate-700 transition">El Gordo Múltiples</a>
                            
                            <div class="px-4 py-2 text-xs font-semibold text-slate-400 border-b border-slate-700 mt-2">APUESTAS REDUCIDAS</div>
                            <a href="<?php echo e(route('juego.apuestas-reducidas', 'euromillones')); ?>" class="block px-4 py-2 text-sm hover:bg-slate-700 transition">Euromillones Reducidas</a>
                            <a href="<?php echo e(route('juego.apuestas-reducidas', 'bonoloto')); ?>" class="block px-4 py-2 text-sm hover:bg-slate-700 transition">Bonoloto Reducidas</a>
                        </div>
                    </div>
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute top-full left-0 mt-1 bg-slate-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10 min-w-[200px]">
                            <a href="<?php echo e(route('juego.combinacion-ganadora', 'euromillones')); ?>" class="block px-4 py-2 text-sm hover:bg-slate-700 transition">Euromillones</a>
                            <a href="<?php echo e(route('juego.combinacion-ganadora', 'bonoloto')); ?>" class="block px-4 py-2 text-sm hover:bg-slate-700 transition">Bonoloto</a>
                            ...
                            <a href="<?php echo e(route('loteria.decimo-premiado')); ?>" class="block px-4 py-2 text-sm hover:bg-slate-700 transition">Lotería Nacional</a>
                        </div>
                    </div>
            </div>
        </div>
    ...
    <footer class="bg-slate-900 text-slate-500 text-center py-6 mt-auto">
        ...
        <p class="text-xs mt-2"><a href="<?php echo e(route('politica-cookies')); ?>" class="hover:text-slate-300 transition">Política de Cookies</a></p>
    </footer>
