...
<section class="mt-12">
    ...
    <div class="grid gap-6 md:grid-cols-2">
        ...
        <article class="bg-white rounded-xl shadow-lg p-6 border-t-4 border-loteria-500">
            ...
            <ul class="space-y-2 text-sm text-slate-700">
                <li><a href="<?php echo e(route('juego.guia', 'loteria-nacional')); ?>" class="text-amber-700 hover:underline">Como se juega a Loteria Nacional</a></li>
                <li><a href="<?php echo e(route('juego.guia', 'loteria-nacional')); ?>" class="text-amber-700 hover:underline">Premios y probabilidades de Loteria Nacional</a></li>
                <li><a href="<?php echo e(route('juego.guia', 'loteria-nacional')); ?>" class="text-amber-700 hover:underline">Sorteos de Loteria Nacional Jueves y Sabado</a></li>
                <li><a href="<?php echo e(route('juego', 'loteria-nacional')); ?>" class="text-amber-700 hover:underline">Ver ultimos resultados</a></li>
            </ul>
        </article>
    </div>
</section>
...
<div class="bg-gradient-to-r from-slate-50 to-blue-50 rounded-xl p-6 border border-slate-200">
    ...
    <div class="grid gap-3 md:grid-cols-2">
        ...
        <a href="<?php echo e(route('juego', 'loteria-nacional')); ?>" class="flex items-center p-3 bg-white rounded-lg hover:shadow-md transition-shadow">
