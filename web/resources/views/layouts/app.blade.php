    ...
    <nav class="bg-slate-700 text-white shadow overflow-x-clip">
        <div class="max-w-7xl mx-auto px-4 py-3">
            ...
            <div class="flex flex-wrap gap-2 mb-2">
                ...
                <a href="{{ route('juego', 'loteria-nacional') }}" class="px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-loteria-500 hover:bg-loteria-600 text-sm sm:text-base font-medium transition">Lotería Nacional</a>
            </div>
            ...
            <div class="flex gap-2 sm:gap-4">
                    <div class="relative group">
                        ...
                        <div class="absolute top-full left-0 mt-1 bg-slate-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10 min-w-[200px]">
                            ...
                            <a href="{{ route('juego.guia', 'loteria-nacional') }}" class="block px-4 py-2 text-sm hover:bg-slate-700 transition">Guía Lotería Nacional</a>
                        </div>
                    </div>
